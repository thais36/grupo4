...
import com.fatec.grupox.services.MantemFornecedor;
...
public class GUIFornecedorController {
	...
	public ModelAndView save(@Valid Fornecedor fornecedor, BindingResult result) {
		...
		//	mv.setViewName("cadastrarFornecedor");
			...
			servico.save(fornecedor);
			logger.info(">>>>>> controller chamou cadastrar e consultar todos");
			mv.addObject("fornecedor", servico.consultaTodos());
	...
	public ModelAndView atualizaFornecedor(@PathVariable("id") Long id, @Valid Fornecedor fornecedor,
			BindingResult result) {
		ModelAndView modelAndView = new ModelAndView("redirect:/grupox/fornecedores");
